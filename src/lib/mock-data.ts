import type { ActionCandidate, EnvState, MCTSIteration, MCTSNode, RunDataset } from "~/lib/contracts";
import { runDatasetSchema } from "~/lib/contracts";
...
const iterations: MCTSIteration[] = [
  {
    iterationIndex: 1,
...
export function getMockRun(): RunDataset {
